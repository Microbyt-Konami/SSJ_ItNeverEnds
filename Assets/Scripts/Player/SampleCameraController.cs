    ...
    public class SampleCameraController : MonoBehaviour
    {
        ...
        public Vector3 GetCameraForwardZeroedY()
        {
            return _mainCamera == null
                ? Vector3.zero
                : new Vector3(_mainCamera.transform.forward.x, 0, _mainCamera.transform.forward.z);
        }
        ...
        public Vector3 GetCameraRightZeroedY()
        {
            return _mainCamera == null
                ? Vector3.zero
                : new Vector3(_mainCamera.transform.right.x, 0, _mainCamera.transform.right.z);
        }
        ...
        {
            return _mainCamera == null ? 0 : _mainCamera.transform.eulerAngles.x;
        }
    }
}
